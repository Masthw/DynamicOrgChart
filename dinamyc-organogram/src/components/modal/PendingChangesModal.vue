<template>
  <q-dialog v-model="isOpen" persistent>
    <q-card class="pending-modal">
      <!-- Ícone de aviso centralizado -->
      <div class="icon-wrapper">
        <div class="icon-container">
          <img src="src/assets/icons/info.png" alt="Atenção" class="modal-icon" />
        </div>
      </div>
      ...
      <q-card-section class="modal-header">
        ...
        <p class="modal-text">
          O envio não pode ser concluído porque existem <br />
          itens que precisam ser ajustados. <br />
          Por favor, revise e corrija as pendências antes de <br />
          continuar.
        </p>
      </q-card-section>
